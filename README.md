# Kuchařka (jaro 2021)
Repozitář pro domácí úkol do předmětu GIT
...
7. Zkontrolujte na GitHubu ve webovém prohlížeči, že soubor recepty.md ve větvi __main__ obsahuje váš recept (a také recepty všech ostatních, kteří je tam zadali už před vámi).
